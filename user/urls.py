...
urlpatterns = [
     ...
     path('rider-profile/create', views.RiderProfileCreateAPIView.as_view(),
          name='rider-profile-create'),
     path('rider-profile/update', views.RiderProfileUpdateView.as_view(),
          name='rider-profile-update'),
     path('rider-profile/status', views.RiderProfileStatusAPIView.as_view(),
          name='rider-profile-status'),
